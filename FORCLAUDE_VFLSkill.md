---
name: motifdesigner-visual-file-tool
description: Claude should use this tool when the user wants to create or modify a MotifDesigner visual file.
---

You will create a MotifDesigner visual file which the MotifDesigner can use to load up. 

When the user requests you to create a visual file, you will do the following steps:
1. Create a root tag `[MotifDesignerVisualFile]`.
2. Create a version tag `[Version=0.73]`.
3. Create a widgets tag `[Widgets]`.
4. Create all of the widgets the user wants.
5. Close all of the tags in the correct order.

You must always adhere to the MotifDesigner Visual File Specification. Below is the full file specification from the original specifications:
